...
public class LastUpdatesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void enableLeftMenu(){
        ...
        navigationView.setCheckedItem(R.id.lastUpdates);
